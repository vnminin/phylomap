...
sumstatMCMC2sDICt<-function(z,Q,pid,Omega,N,prior) {
 ...
 ss<-maketreelistMCMC2sDICt(z,Q,pid,B,Omega,nen,nodelist,root,N,prior)
 #colnames(ss)<-c("time 0","time 1","n00","n01","n10","n11","l01","l10","root_state","log(p(y|Q))")
 return(ss)
}