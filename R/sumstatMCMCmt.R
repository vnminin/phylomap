...
sumstatMCMCmt<-function(treelist,Q,pid,Omega,N,prior) {
 ...
 ss<-maketreelistMCMCmt(treelist,Q,pid,B,Omega,nen_m,nodelist_m,roots,N,prior)
 colnames(ss)<-c("time_0","time_1","n00","n01","n10","n11","l01","l10","tree_number")
 return(ss)
