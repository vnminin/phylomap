...
RcppExport SEXP phylomap_maketreelistMCMC_bigtree(SEXP xSEXP, SEXP QSEXP, SEXP pidSEXP, SEXP BSEXP, SEXP OmegaSEXP, SEXP nenSEXP, SEXP nodelistSEXP, SEXP rootSEXP, SEXP NSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
        ...
        Rcpp::traits::input_parameter< int >::type root(rootSEXP );
        Rcpp::traits::input_parameter< int >::type N(NSEXP );
        NumericMatrix __result = maketreelistMCMC_bigtree(x, Q, pid, B, Omega, nen, nodelist, root, N);
        PROTECT(__sexp_result = Rcpp::wrap(__result));
    }
    UNPROTECT(1);
    return __sexp_result;
